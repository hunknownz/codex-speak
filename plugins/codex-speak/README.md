...
- Provide MCP tools for status, preview, stop, test speech, enable/disable, child mode, speed, voice profiles, TTS provider switching, model installation, and side-channel preparation.
